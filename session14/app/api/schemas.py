...
class MeetingStatusCounts(BaseModel):
    scheduled: int = 0
    in_progress: int = 0
    completed: int = 0
    cancelled: int = 0
...
class ActionItemStatusCounts(BaseModel):
    open: int = 0
    in_progress: int = 0
    completed: int = 0
...
class DashboardSummary(BaseModel):
    ...
    meetings_by_status: MeetingStatusCounts = Field(description="Meeting count grouped by status")
    total_action_items: int = Field(description="Total action items across all meetings")
    action_items_by_status: ActionItemStatusCounts = Field(description="Action item count grouped by status")
    total_notes: int = Field(description="Total notes across all meetings")
    total_decisions: int = Field(description="Total decisions across all meetings")
